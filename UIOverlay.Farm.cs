...
namespace CloudMeadow.CreativeMode
{
    internal partial class UIOverlay
    {
        ...
        private object[] GetCachedAllBloodlineTraitDefs()
        {
            ...
            {
                var bloodlineTraits = GameApi.GetBloodlineTraitDefinitionsForAllSpeciesUI();
                _cacheAllBloodlineTraitDefsStatic = SortTraitDefinitions(bloodlineTraits);
                LogBuffer.Add("UI Bloodline traits cached: " + _cacheAllBloodlineTraitDefsStatic.Length);
            }
